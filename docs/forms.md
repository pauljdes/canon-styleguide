...
<div class="flex flex-wrap pa4">
  <form>
    <section class="pv3 pr3-ns black-80 w-100 w-50-ns fl">
      ...
      <input id="name" class="mb2 input-reset bg-transparent b--black-20 pv3 ph3 bt-0 bl-0 br-0 bw1 bb w-100" type="text" aria-describedby="name-desc">
    ...
    <section class="pv3 pl3-ns black-80 w-100 w-50-ns fl">
      ...
      <input id="password" value="hunter2" class="mb2 input-reset bg-transparent b--c-red pv3 ph3 bt-0 bl-0 br-0 bw1 bb w-100" type="password" aria-describedby="pass-desc">
    ...
    <section class="pv3 black-80 w-100 w-100-ns fl">
      ...
      <input id="password" placeholder="Placeholder" class="mb2 input-reset bg-transparent b--black-20 pv3 ph3 bt-0 bl-0 br-0 bw1 bb w-100" type="text" aria-describedby="pass-desc">
    </section>
